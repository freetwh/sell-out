...
export const stages: GuideStage[] = [
  ...
  S->>B: 发送规格表/样品/报价下一步`,
    knowledge: [
      ...
      "信任竞争下，话术不要先夸自己强，而要先说明你理解客户的采购场景、使用风险和决策压力。",
    ...
    pitfalls: [
      "不要第一封邮件塞太多附件，容易进垃圾箱。",
      "不要用万能模板硬套所有客户，客户会先判断你是否真的理解他的业务。",
      "不要只说 best quality、competitive price，要换成可核验事实和对客户场景的具体帮助。",
      "不要用私人邮箱代表公司做长期外贸开发。",
  ...
  H --> I[正式 PI 或合同]`,
    knowledge: [
      ...
      "转化话术的核心顺序：先确认使用场景，再确认关键风险，最后给出产品事实和下一步动作。",
      "客户常见疑虑包括质量是否稳定、是否符合认证、交期是否可靠、价格为什么不同、样品和大货是否一致、售后如何处理。",
      "回答疑虑时用“事实 + 解释 + 选择”的结构：给出测试/证书/案例/图片/视频，再解释影响，最后给客户一个低风险下一步。",
    ...
    beginnerPath: [
      ...
      "建立一张疑虑回应表：每个高频问题对应事实证据、可承诺范围、不能承诺的边界和推荐下一步。",
      "报价前先复述客户场景，例如销售渠道、目标用户、包装要求和交付时间，让客户感觉你是在替他降低风险。",
    ...
    pitfalls: [
      ...
      "不要为了拿单承诺无法证明的认证、产能、交期或客户案例。",
      "不要把客户疑虑当成刁难，很多疑虑本质是在确认供应商是否可控。",
      "不要发送过期证书、模糊图片或不一致参数。",
